...
use crate::{
    common::{
        self, CgroupManager, ControllerOpt, FreezerState, JoinSafelyError, PathBufExt, CGROUP_PROCS,
    },
...
impl Manager {
    ...
    pub fn new(root_path: PathBuf, cgroup_path: PathBuf) -> Result<Self, JoinSafelyError> {
